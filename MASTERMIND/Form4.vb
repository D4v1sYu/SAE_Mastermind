...
Public Class Form4
    ...
    Private CouleurPres As Color = Color.ForestGreen
    Private CouleurPresBien As Color = Color.MidnightBlue
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ColPres.Color = CouleurPres
        ColPresBien.Color = CouleurPresBien
