...
Options :
-
Si l’utilisateur le souhaite, il peut modifier certains parametres de jeu liés aux parties. 
...
En pratique :
-
Des données sont enregistrées dans un fichier pour pouvoir etre affichées lors des prochains lancements de programme.
...
Un formulaire dédié permet la visualisation de ces données. 
...
J'ai eu l'opportunité de travailler avec des personnes de confiance, il a toujours été tres dur pour moi de partager la responsabilité de mon code.
...
tout le design de la page en général auraient pu etre meilleurs avec un style unifié.
